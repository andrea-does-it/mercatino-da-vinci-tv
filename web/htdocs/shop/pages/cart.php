...
<div class="col-md-12 order-md-2 mb-4">
  <?php if (count($cart_items) > 0) : ?>
    <h4 class="d-flex justify-content-between align-items-center mb-3">
      ...
      <span class="badge badge-secondary badge-pill"><span id="numOfCartItems"><?php echo esc_html($cart_total[0]['num_products']); ?></span> libri nel carrello</span>
    </h4>
    ...
    <li data-product-id="<?php echo esc_html($item['product_id']); ?>" class="list-group-item product-box d-flex justify-content-between lh-condensed p-4">
      <div class="row w-100">      
        <div class="col-lg-4 col-6">
          ...
          <small class="text-muted"><?php echo shorten(esc_html($item['product_ISBN'])); ?></small>
        </div>
  ...
  <?php else : ?>
    ...
    <a href="<?php echo ROOT_URL . 'shop/?page=products-list'; ?>" class="btn btn-primary btn-lg mb-5 mt-3">Vai ai Libri Adottati &raquo;</a>
  <?php endif ; ?>
