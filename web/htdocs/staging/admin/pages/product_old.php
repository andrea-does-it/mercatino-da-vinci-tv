 ...
 <!-- <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="mtitle" id="mtitle" value="<?php echo esc_html($product->mtitle); ?>" >
        </div>
      </div>
    </div>-->
    <div class="col-md-6">
      <div class="form-group">
        <label for="mtitle"><strong>Autori</strong></label>
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="mtitle" id="mtitle value="<?php echo esc_html($product->mtitle); ?>" >
        </div>
      </div>
  ...
  <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="metadescription" id="metadescription" value="<?php echo esc_html($product->metadescription); ?>" >
        </div>
      </div>
  </div>
</div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" name="description" id="description" value="<?php echo esc_html($product->description); ?>" >
        </div>
      </div>
    </div>    
    <div class="col-md-4">
