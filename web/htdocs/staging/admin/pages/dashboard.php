...
<div class="card mb-3 mt-3">
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item"><a href="<?php echo ROOT_URL; ?>admin/?page=news-management" class="underline">Gestione News &raquo;</a></li>
    <li class="list-group-item"><a href="<?php echo ROOT_URL; ?>admin/?page=download-management" class="underline">Gestione Downloads &raquo;</a></li>
  </ul>
</div>
